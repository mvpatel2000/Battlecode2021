...
public class Slanderer extends Unit {
    ...
    int spiralVersion = 0;
    static int[][] SLANDERER_SPIRAL_ORDER = {{1,2},{2,1},{2,-1},{1,-2},{-1,-2},{-2,-1},{-2,1},{-1,2},{0,3},{3,0},{0,-3},{-3,0},{2,3},{3,2},{3,-2},{2,-3},{-2,-3},{-3,-2},{-3,2},{-2,3},{1,4},{4,1},{4,-1},{1,-4},{-1,-4},{-4,-1},{-4,1},{-1,4},{0,5},{3,4},{4,3},{5,0},{4,-3},{3,-4},{0,-5},{-3,-4},{-4,-3},{-5,0},{-4,3},{-3,4},{2,5},{5,2},{5,-2},{2,-5},{-2,-5},{-5,-2},{-5,2},{-2,5}};
    ...
    public void scanSpiral() throws GameActionException {
        ...
        while (scanSpiralHelper()) {
            indexInSpiralOrder++;
            // switch to next list
            if (indexInSpiralOrder == SLANDERER_SPIRAL_ORDER.length) {
                indexInSpiralOrder = 0;
                spiralVersion++;
                switch (spiralVersion) {
                    case 1: {
                        int[][] NEW_SPIRAL_ORDER = {{1,6},{6,1},{6,-1},{1,-6},{-1,-6},{-6,-1},{-6,1},{-1,6},{4,5},{5,4},{5,-4},{4,-5},{-4,-5},{-5,-4},{-5,4},{-4,5},{3,6},{6,3},{6,-3},{3,-6},{-3,-6},{-6,-3},{-6,3},{-3,6},{0,7},{7,0},{0,-7},{-7,0},{2,7},{7,2},{7,-2},{2,-7},{-2,-7},{-7,-2},{-7,2},{-2,7},{5,6},{6,5},{6,-5},{5,-6},{-5,-6},{-6,-5},{-6,5},{-5,6}};
                        SLANDERER_SPIRAL_ORDER = NEW_SPIRAL_ORDER;
                        break;
                    }
                    case 2: {
                        int[][] NEW_SPIRAL_ORDER = {{1,8},{4,7},{7,4},{8,1},{8,-1},{7,-4},{4,-7},{1,-8},{-1,-8},{-4,-7},{-7,-4},{-8,-1},{-8,1},{-7,4},{-4,7},{-1,8},{3,8},{8,3},{8,-3},{3,-8},{-3,-8},{-8,-3},{-8,3},{-3,8},{0,9},{9,0},{0,-9},{-9,0},{2,9},{6,7},{7,6},{9,2},{9,-2},{7,-6},{6,-7},{2,-9},{-2,-9},{-6,-7},{-7,-6},{-9,-2},{-9,2},{-7,6},{-6,7},{-2,9},{5,8},{8,5},{8,-5},{5,-8},{-5,-8},{-8,-5},{-8,5},{-5,8}};
                        SLANDERER_SPIRAL_ORDER = NEW_SPIRAL_ORDER;
                        break;
                    }
                    case 3: {
                        int[][] NEW_SPIRAL_ORDER = {{4,9},{9,4},{9,-4},{4,-9},{-4,-9},{-9,-4},{-9,4},{-4,9},{1,10},{10,1},{10,-1},{1,-10},{-1,-10},{-10,-1},{-10,1},{-1,10},{3,10},{10,3},{10,-3},{3,-10},{-3,-10},{-10,-3},{-10,3},{-3,10},{7,8},{8,7},{8,-7},{7,-8},{-7,-8},{-8,-7},{-8,7},{-7,8},{6,9},{9,6},{9,-6},{6,-9},{-6,-9},{-9,-6},{-9,6},{-6,9},{0,11},{11,0},{0,-11},{-11,0},{2,11},{5,10},{10,5},{11,2},{11,-2},{10,-5},{5,-10},{2,-11},{-2,-11},{-5,-10},{-10,-5},{-11,-2},{-11,2},{-10,5},{-5,10},{-2,11}};
                        SLANDERER_SPIRAL_ORDER = NEW_SPIRAL_ORDER;
                        break;
                    }
                    default: {
