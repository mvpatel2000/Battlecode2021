        ...
        if (!isMidGame && initialBuildStep < 4) {
            ...
            switch (initialBuildStep) {
                case 0:
                    ...
                    break;
                case 1:
                    spawnRobotWithTracker(RobotType.MUCKRAKER, optimalDir, 1, optimalDestination(false), SpawnDestinationFlag.INSTR_DEFAULT, spawnDestIsGuess);
                    break;
                case 2:
                    spawnRobotWithTracker(RobotType.MUCKRAKER, optimalDir, 1, optimalDestination(false), SpawnDestinationFlag.INSTR_DEFAULT, spawnDestIsGuess);
                    break;
                case 3:
                    spawnRobotWithTracker(RobotType.POLITICIAN, optimalDir, 14, optimalDestination(false), SpawnDestinationFlag.INSTR_DEFAULT, spawnDestIsGuess);
                    break;
                default:
                    break;
            }
