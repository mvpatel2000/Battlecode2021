...
public class MapTerrainTest {
	...
	public void testOverflow() throws GameActionException {
        ...
        mtq.step(null, Direction.NORTHEAST, new MapLocation(2,3));
        assertEquals(30, mtq.getSize());
        // assertEquals(0, mtq.start);
        mtq.step(null, Direction.NORTHEAST, new MapLocation(3,4));
        assertEquals(45, mtq.getSize());
        // assertEquals(0, mtq.start);
        mtq.step(null, Direction.NORTHEAST, new MapLocation(4,5));
